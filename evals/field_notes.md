...
| ---------- | ----------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Goal image | Test whether the target image is the main bottleneck.                   | Pre-chop, active-chop, post-chop, oak, birch, `goal_tree_nav.pkl`, `goal_tree_chop.pkl`.           | Pre-chop is best for navigation. Active-chop reduces latent MSE but does not finish chopping. Post-chop is too hard as the first goal.                                       |
